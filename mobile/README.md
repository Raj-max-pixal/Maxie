...
For judge-facing details, use [SHIPATHON_SUBMISSION.md](SHIPATHON_SUBMISSION.md). For store release work, use [PLAY_STORE_RELEASE_CHECKLIST.md](PLAY_STORE_RELEASE_CHECKLIST.md).
